...
//        this.rootComponent = createRootComponent();
    ...
    private SimpleTree<DemoLesson> createLessonsTree() {
        ...
        lessonsTree.setTemplatesByDepth(BaseTemplate.LIST_ITEM_LARGE_ICON_TWO_LINES, BaseTemplate.LIST_ITEM_MEDIUM_ICON_TWO_LINES);
        lessonsTree.setOpenOnSelection(true);
        lessonsTree.setEnforceSingleExpandedPath(true);
        lessonsTree.setShowExpanders(true);
        lessonsTree.setIndentation(10);
        ...
        BaseTemplateTreeNode<DemoLesson> l02_TextField = new BaseTemplateTreeNode<>(MaterialIcon.TEXT_FIELDS, null ," TextField", "with event handling","2", new TextFieldDemo());
        l02_TextField.setParent(introLessons);
        lessonsTree.addNode(l02_TextField);

        BaseTemplateTreeNode<DemoLesson> l03_verticallayout = new BaseTemplateTreeNode<>(MaterialIcon.LAYERS, null ,"Vertical Layout", "Multiple components","3", new VerticalLayoutDemo());
        l03_verticallayout.setParent(introLessons);
        lessonsTree.addNode(l03_verticallayout);

        BaseTemplateTreeNode<DemoLesson> l04_richtexteditor = new BaseTemplateTreeNode<>(MaterialIcon.TEXT_FORMAT, null ,"Rich Text Editor", "Formatted text","4", new RichTextEditorDemo());
        l04_richtexteditor.setParent(introLessons);
        lessonsTree.addNode(l04_richtexteditor);

        BaseTemplateTreeNode<DemoLesson> l05_label = new BaseTemplateTreeNode<>(MaterialIcon.DESCRIPTION, null ,"Labels", "TextField labels","5", new LabelDemo());
        l05_label.setParent(introLessons);
        lessonsTree.addNode(l05_label);

        BaseTemplateTreeNode<DemoLesson> l06_button = new BaseTemplateTreeNode<>(MaterialIcon.ADD_BOX, null ,"Button", "Button","6", new ButtonDemo());
        l06_button.setParent(introLessons);
        lessonsTree.addNode(l06_button);

        BaseTemplateTreeNode<DemoLesson> l07_checkbox = new BaseTemplateTreeNode<>(MaterialIcon.CHECK_BOX, null ,"CheckBox", "Switches","7", new CheckboxDemo());
        l07_checkbox.setParent(introLessons);
        lessonsTree.addNode(l07_checkbox);

        BaseTemplateTreeNode<DemoLesson> l08_combobox = new BaseTemplateTreeNode<>(MaterialIcon.LIST, null ,"ComboBox", "with BeanPropertyExtractor","8", new ComboBoxDemo());
        l08_combobox.setParent(introLessons);
        lessonsTree.addNode(l08_combobox);

        BaseTemplateTreeNode<DemoLesson> l09_propertyextractor = new BaseTemplateTreeNode<>(MaterialIcon.QUESTION_ANSWER, null ,"PropertyExtractor", "with TagComboBox and Property Mapping","9", new PropertyExtractorDemo());
        l09_propertyextractor.setParent(introLessons);
        lessonsTree.addNode(l09_propertyextractor);

        BaseTemplateTreeNode<DemoLesson> l10_responsiveform = new BaseTemplateTreeNode<>(MaterialIcon.SAVE, null ,"ResponsiveForm", "Complete Form with Data saving","10", new ResponsiveFormDemo());
        l10_responsiveform.setParent(introLessons);
        lessonsTree.addNode(l10_responsiveform);

        BaseTemplateTreeNode<DemoLesson> l11_table = new BaseTemplateTreeNode<>(MaterialIcon.FILTER_LIST, null ,"Table", "Table with various Fields","11", new TableDemo());
        l11_table.setParent(introLessons);
        lessonsTree.addNode(l11_table);

        BaseTemplateTreeNode<DemoLesson> l12_toolbar = new BaseTemplateTreeNode<>(MaterialIcon.CLOUD_UPLOAD, null ,"Toolbar", "Toolbar and Custom Icons","12", new ToolbarDemo());
        l12_toolbar.setParent(introLessons);
        lessonsTree.addNode(l12_toolbar);

        BaseTemplateTreeNode<DemoLesson> l13_tree = new BaseTemplateTreeNode<>(MaterialIcon.EXPAND_MORE, null ,"Tree", "SimpleTree","13", new TreeDemo());
        l13_tree.setParent(introLessons);
        lessonsTree.addNode(l13_tree);

        BaseTemplateTreeNode<DemoLesson> l14_responsiveapplication = new BaseTemplateTreeNode<>(MaterialIcon.FOLDER_OPEN, null ,"Responsive Application", "Layout Design","14", new ResponsiveApplicationDemo());
        ...
        BaseTemplateTreeNode<DemoLesson> l01_backgroundtasks = new BaseTemplateTreeNode<>(MaterialIcon.HOURGLASS_EMPTY, null ,"Background Tasks", "Background calculations...","01", new BackgroundTasksDemo());
        l01_backgroundtasks.setParent(applicationLessons);
        lessonsTree.addNode(l01_backgroundtasks);

        BaseTemplateTreeNode<DemoLesson> l02_externalevent = new BaseTemplateTreeNode<>(MaterialIcon.ALARM_ON, null ,"External Event", "Events between sessions","02", new ExternalEventsDemo());
        l02_externalevent.setParent(applicationLessons);
        lessonsTree.addNode(l02_externalevent);

        BaseTemplateTreeNode<DemoLesson> l03_servlet = new BaseTemplateTreeNode<>(MaterialIcon.ROOM_SERVICE, null ,"Servlet", "Create Events from an additional Endpoint","03", new ServletDemo());
        l03_servlet.setParent(applicationLessons);
        lessonsTree.addNode(l03_servlet);

        BaseTemplateTreeNode<DemoLesson> l04_mustachetemplate = new BaseTemplateTreeNode<>(MaterialIcon.STARS, null ,"MustacheTemplate", "Versatile Custom Elements","03", new MustacheTemplateDemo());
